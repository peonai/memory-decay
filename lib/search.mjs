...
const DOMAIN_ALIASES = {
  'payment': ['支付', '付款', '收款', '订阅', 'stripe', 'creem', 'checkout', 'license', '定价', '价格'],
  'infra': ['部署', '服务器', 'server', 'deploy', 'nginx', 'pm2', 'ssh', 'gateway', '路由', 'route', 'tts', '语音', 'edge-tts', 'cron', '运维', 'tailscale', 'proxy', '代理'],
  'blog': ['博客', '文章', 'hugo', '写作', 'post', '双语', 'newspaper', 'css', '样式', '字体', 'font'],
  'chrome-ext': ['插件', '扩展', 'extension', 'chrome', '翻译', 'translator', 'bookmarker', '浏览器'],
