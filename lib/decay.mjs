// decay.mjs — Decay engine: time-based tier demotion
import { readIndex, writeIndex, readMemory, moveMemory, getStoreRoot } from './store.mjs';
  ...
  for (const entry of index) {
    ...
    if (newTier !== entry.tier) {
      ...
      if (!dryRun) {
        ...
        // Compress summary for faded/ghost tiers
